...
Изучить датасет на предмет аномалий, пропусков, ошибок и ,по возможности, исправить их.
При необходимости создать дополнительные категории по имеющимся данным.
Найти критерии, которые влияют на стоимость продажи квартир.
Визуализировать полученную информацию
Сформулировать итоговый вывод по результатам исследования.
